...
min_score = st.sidebar.slider("Revenue Score", 0, max(max_score, 1), 0)
...
min_profit = st.sidebar.slider("推定利益 下限", 0, max(max_profit, 1), 0)
...
recoverable_total = int(df_view[df_view["status"] == "未対応"]["recoverable_profit"].sum())
